                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            @if($article->featured_image)
                                <div class="mt-2">
                                    <img src="{{ Storage::url($article->featured_image) }}" alt="Current featured image" class="h-32 w-auto">
                                </div>
                            @endif
                            <div class="mt-1">
                        ...
                        <div>
                            ...
                            @if($article->thumbnail)
                                <div class="mt-2">
                                    <img src="{{ Storage::url($article->thumbnail) }}" alt="Current thumbnail" class="h-24 w-auto">
                                </div>
                            @endif
                            <div class="mt-1">
